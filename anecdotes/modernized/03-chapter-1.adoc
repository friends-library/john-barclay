...
saying, that was the true light, which enlightens every man that comes into the world,
...
you will not be able to stand;`" And while we were yet discoursing,
...
The Lord still commanded me to go, showing that He would provide a helpmate for me.
