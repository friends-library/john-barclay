...
* 1649: Being a member of the Scottish Parliament for Aberdeen, he is twice sent to Holland, with other commissioners, to treat with King Charles the Second.
...
where they with great fury and many fearful oaths did threaten sore,
...
being about the slaying of an ox, which they had lying within the door.
