...
we may be enabled to build one another up in every thing good;
...
The Lord remains to be to his devoted servants the same yesterday, to-day, and forever,
...
[.signed-section-context-open]
Alton, 15th ofTwelfth month, 1827.
